  ...
  return (
    <>
      ...
      <div className="max-w-6xl mx-auto px-4 py-16">
        <h1 className="text-teal mb-12">Our Services</h1>
        ...
        <section id="home-modifications" className="mb-16 pb-16 border-b">
          <div className="flex items-start gap-8">
            ...
            <div className="flex-1">
              <h2 className="text-teal">Home Modifications</h2>
        ...
        <section id="ndis" className="mb-16 pb-16 border-b">
          <div className="flex items-start gap-8">
            ...
            <div className="flex-1">
              <h2 className="text-teal">NDIS Complex Home Modifications</h2>
        ...
        <section id="assistive-tech">
          <div className="flex items-start gap-8">
            <div className="text-6xl flex-shrink-0">🔧</div>
            <div className="flex-1">
              <h2 className="text-teal">Assistive Technology & Equipment</h2>
