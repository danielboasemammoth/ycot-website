  ...
  return (
    <>
      ...
      <div className="max-w-6xl mx-auto px-4 py-16">
        <h1 className="text-teal mb-2">Get In Touch</h1>
            ...
            <div className="space-y-8">
              <div>
                ...
                <p className="text-gray-700 text-lg">
                  <a href="tel:0421196672" className="text-teal hover:underline">0421 196 672</a>
                </p>
              </div>
              ...
              <div>
                ...
                <p className="text-gray-700 text-lg">
                  <a href="mailto:admin@yourchoiceot.com.au" className="text-teal hover:underline">admin@yourchoiceot.com.au</a>
                </p>
              </div>
              ...
              <div>
                ...
                <a href="https://facebook.com/yourchoiceot" target="_blank" rel="noopener noreferrer" className="text-teal hover:underline font-semibold">
                  Follow us on Facebook →
                </a>
              </div>

              <div className="bg-teal-50 p-6 rounded-lg mt-8">
                <h3 className="font-bold text-lg mb-3 text-teal">Your Inquiry</h3>
        ...
        <section className="mt-16 pt-16 border-t">
          <h2 className="text-teal text-center mb-8">Share Your Feedback</h2>
          ...
          <form className="max-w-2xl mx-auto bg-gray-50 p-8 rounded-lg">
            ...
            <textarea
              ...
              rows={5}
              required
              className="w-full border border-gray-300 rounded-lg px-4 py-3 mb-4 focus:outline-none focus:ring-2 focus:ring-teal"
            />
