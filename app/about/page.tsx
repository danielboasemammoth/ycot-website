  ...
  return (
    <>
      ...
      <div className="max-w-6xl mx-auto px-4 py-16">
        <h1 className="text-teal mb-8">About Your Choice OT</h1>

        <section className="prose prose-lg max-w-none mb-12">
          <h2 className="text-teal">Why We Do What We Do</h2>
        ...
        <section className="mt-16">
          <h2 className="text-teal mb-12">Meet Our Team</h2>
          ...
          <div className="grid md:grid-cols-2 gap-12 mb-12">
            ...
            <div className="border border-gray-200 rounded-lg p-8">
              ...
              <p className="text-teal font-semibold mb-4">Owner & Senior Occupational Therapist</p>
            ...
            <div className="border border-gray-200 rounded-lg p-8">
              ...
              <p className="text-teal font-semibold mb-4">Office Manager & Administration</p>
        ...
        {/* Credentials */}
        <section className="bg-teal text-white p-12 rounded-lg mt-16">
          <h2 className="text-white mb-8">Certified Care & Approvals</h2>
          <div className="grid md:grid-cols-4 gap-6">
            <div className="text-center">
              <p className="text-4xl mb-3">✓</p>
              <p className="font-semibold">Occupational Therapy Australia</p>
              <p className="text-sm text-teal-light">Member</p>
            </div>
            <div className="text-center">
              <p className="text-4xl mb-3">✓</p>
              <p className="font-semibold">NDIS Provider</p>
              <p className="text-sm text-teal-light">Approved for Complex Modifications</p>
            </div>
            <div className="text-center">
              <p className="text-4xl mb-3">✓</p>
              <p className="font-semibold">MAC Provider</p>
              <p className="text-sm text-teal-light">My Aged Care Services</p>
            </div>
            <div className="text-center">
              <p className="text-4xl mb-3">✓</p>
              <p className="font-semibold">Medicare Australia</p>
              <p className="text-sm text-teal-light">Approved Provider</p>
            </div>
          </div>
        </section>
      </div>
